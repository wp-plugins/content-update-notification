<?php
/**
 * Content Update Notification - Content Module
 *
 * Contains the content generation functionality
 *
 * @package Content Update Notification
 */
...
class CUN_Content {
	 ...
	 * @return [type]          [description]
	 */
	public static function build_notification_email( $post_id = 0, $data = array() ) {
